    ...
    <?php include 'navbar.php'; ?>
      <div role="main" class="main">
        ...
        >
          ...
          <div
            class="shape-divider shape-divider-bottom shape-divider-reverse-x"
            style="height: 123px"
          >
            <svg
              version="1.1"
          ...
          <div class="container pb-5">
            <div class="row align-items-center py-2 my-5 mb-lg-0 my-xl-5">
              <div class="col-lg-7 mb-5 mb-lg-0">
                <h2
                  class="text-9 line-height-3 text-transform-none font-weight-semibold mb-4 text-color-white"
                >
                  Skills That Make a Meaningful Difference for Your Business
                </h2>
                <p class="text-3-5 pb-3 mb-4 text-color-dark">
                  Cras a elit sit amet leo accumsan volutpat. Suspendisse
                  hendreriast ehicula leo, vel efficitur felis ultrices non.
                  Cras a elit sit amet leo acun volutpat.
                </p>
                <div class="progress-bars pb-5 text-color-white">
                  <div class="progress-label d-flex justify-content-between">
                    <span class="font-weight-semibold text-2"
                      >STRATEGY ACCELERATION</span
                    >
                    <span class="font-weight-semibold text-2">90%</span>
                  </div>
                  <div
                    class="progress progress-xs progress-no-border-radius bg-color-grey-scale-2 mb-4"
                  >
                    <div
                      class="progress-bar"
                      style="background-color: #c6a265;"
                      data-appear-progress-animation="90%"
                    ></div>
                  </div>

                  <div
                    class="progress-label d-flex justify-content-between pt-2"
                  >
                    <span class="font-weight-semibold text-2"
                      >REVENUE GROWTH</span
                    >
                    <span class="font-weight-semibold text-2">80%</span>
                  </div>
                  <div
                    class="progress progress-xs progress-no-border-radius bg-color-grey-scale-2 mb-4"
                  >
                  ...
                  >
                    <span class="font-weight-semibold text-2"
                      >FIREWALK SALES</span
                    >
                    <span class="font-weight-semibold text-2">50%</span>
                  </div>
                  <div
                    class="progress progress-xs progress-no-border-radius bg-color-grey-scale-2 mb-4"
                  >
              ...
              <div class="col-lg-5">
                <img
                  src="img/demos/business-consulting-3/generic/generic-4-grey.jpg"
                  class="img-fluid"
                  alt=""
                />
              </div>
