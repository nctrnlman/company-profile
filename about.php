  ...
  <div class="body">
      ...
      <div class="container pt-5">
        <div class="row">
          <div class="col-lg-6 mb-4" style="text-align: justify;">
            <h2 class="text-5 font-weight-bold mb-3">
    ...
    <section class="section section-height-4 section-with-shape-divider border-0 pb-5 m-0" style="background-color: #af2a25">
          ...
          <div class="col mt-5 ">
            <div class="tabs tabs-bottom tabs-center tabs-simple custom-tabs-style-1 ">
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link active text-color-white" href="#tabsNavigationManifesto" data-bs-toggle="tab">Open Minded</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-color-white" href="#tabsNavigationVision" data-bs-toggle="tab">Sharing</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-color-white" href="#tabsNavigationMission" data-bs-toggle="tab">Responsibility</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link text-color-white" href="#tabsNavigationInnovative" data-bs-toggle="tab">Innovative</a>
                </li>
              </ul>
      ...
      <div class="shape-divider shape-divider-bottom shape-divider-reverse-x" style="height: 123px">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 123" preserveAspectRatio="xMinYMin">
          <polygon fill="#c6a265" points="0,90 221,60 563,88 931,35 1408,93 1920,41 1920,-1 0,-1 " />
          <polygon fill="#ffff" points="0,75 219,44 563,72 930,19 1408,77 1920,25 1920,-1 0,-1 " />
        </svg>
      </div>
    </section>
