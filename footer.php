<footer
        id="footer"
        class="border-top-0 m-0 lazyload"
        style="
        ...
        <div class="container pt-7">
          ...
          <div class="row pt-3 mt-5">
            <div class="col-lg-3 mb-4 mb-lg-0">
              <a
                href="demo-business-consulting-3.html"
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
              <ul class="list list-icons list-icons-lg">
                ...
                <li
                  class="d-flex font-weight-semibold text-color-light px-0 mb-1"
                >
                  <img
                    width="25"
                  ...
                  />
                  APL Tower Lt. 38 Suite T5-6, Jl. Letjen S. Parman No.Kav. 28, RT.3/RW.5, Tj. Duren Sel., Kec. Grogol petamburan, Daerah Khusus Ibukota Jakarta 11470
                </li>
              </ul>
            </div>
