    ...
    <section class="vh-100">
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="card py-3 col-md-8 col-lg-6 col-xl-4 offset-xl-1" style="box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    <div class="text-center mt-2 mb-5">
                        <h5 class="text-color-dark" style="font-size: 22px;">Welcome Back !</h5>
                        <p class="text-muted" style="font-size: 15px;">Sign in to continue to admin page.</p>
                    </div>
