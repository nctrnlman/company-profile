...
<body>
  <div class="body">
    ...
    <div role="main" class="main">
        ...
        <div class="container pb-5 my-3">
          <div class="row mb-4">
            <div class="col-md-12 align-self-center p-static order-2 text-center">
              <h1 class="font-weight-bold text-color-white text-10" style="text-shadow: 5px 5px 10px black;">MLDP</h1>
            </div>
      ...
      <div class="container pt-3 pb-4 mt-4 mb-5">
        ...
        <p style="font-size: 18px; color: #777;"
            ...
            <div style="text-align: center;">
              <img src="img\demos\business-consulting-3\backgrounds\comingsoon.png" alt="Background Image" class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" style="max-width: 15%; height: auto; margin-top: 20px; margin-bottom:20px; ">
          ...
          >
            <div class="col-md-5 col-lg-3 mb-4 mb-lg-0">
              <div class="bg-light custom-box-shadow-1 text-center py-5">
                <img
                  class="d-inline-block img-fluid py-5 my-5"
              ...
              <blockquote class="custom-blockquote-style-1 m-0 pt-1 pb-2">
                ...
                >
                  <p>
                    ...
                    Curabitur vulputate posuere tortor luctus vulputate. Cras
                    laoreet pretium blandit. Vestibulum luctus laoreet lacinia.
                    Maecenas luctus arcu ut orci lacinia ultrices. Praesent
                    semper porta interdum. Etiam cursus, tortor at interdum
                    rutrum, metus nibh tincidunt purus, non tincidunt odio arcu
                    quis erat.
                  </p>
                  <p>
                    Curabitur vulputate posuere tortor luctus vulputate. Cras
                    ...
                    semper porta interdum. Etiam cursus, tortor at interdum
                    rutrum, metus nibh tincidunt purus, non tincidunt odio arcu
                    quis erat. Lorem ipsum dolor sit amet, consectetur
                    adipiscing elit. Curabitur vulputate posuere tortor luctus
                    vulputate. Cras laoreet pretium.
                  </p>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  </p>
    ...
    <!-- <section
        ...
        >
          <div
            class="shape-divider shape-divider-reverse-x z-index-3"
            style="height: 102px"
          >
            <svg
              version="1.1"
          ...
          <div class="container">
            <div class="row align-items-center pt-5 pb-xl-5 mt-5">
              <div class="col-md-7 col-lg-8 py-4 my-2 ms-md-3 ms-lg-0">
                ...
                <h3
                  class="text-9 line-height-3 text-transform-none font-weight-medium text-color-light ls-0 mb-3 pb-1 appear-animation"
                  data-appear-animation="fadeInUpShorter"
                  data-appear-animation-delay="500"
                >
                ...
                >
                  ...
                  <div class="row">
                    <div
                      class="form-group col appear-animation"
                      data-appear-animation="fadeInUpShorter"
