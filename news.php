                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-sm-9 col-md-6 col-lg-4 mb-4">
                        <div style="background: rgba(139, 0, 0, 0.85); backdrop-filter: blur(10px); border-radius: 10px; padding: 10px; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 12px 20px rgba(0, 0, 0, 0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none';">
                            <img src="img/demos/business-consulting-3/backgrounds/BCPM/DJI_0864.JPG" class="card-img-top" alt="Article Image">
                            <div class="card-body">
                                <h4 class="font-weight-semibold text-color-light text-6 mb-1">News Title 1</h4>
                                <p class="card-text mb-3" style="font-size: 0.875rem; color: white;">Publication Date: January 1, 2023</p>
                                <p class="card-text" style="font-size: 0.875rem; color: white;">A brief description of the news article goes here. You can provide a summary of the article's content.</p>
                            </div>
                            <div class="card-footer text-center"> <!-- Center-align the button -->
                                <a href="news-article1.html" class="btn btn-primary">Read More</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-9 col-md-6 col-lg-4 mb-4">
                        <div style="background: rgba(139, 0, 0, 0.85); backdrop-filter: blur(10px); border-radius: 10px; padding: 10px; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 12px 20px rgba(0, 0, 0, 0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none';">
                            <img src="img/demos/business-consulting-3/backgrounds/BCPM/DJI_0864.JPG" class="card-img-top" alt="Article Image">
                            <div class="card-body">
                                <h4 class="font-weight-semibold text-color-light text-6 mb-1">News Title 2</h4>
                                <p class="card-text mb-3" style="font-size: 0.875rem; color: white;">Publication Date: January 1, 2023</p>
                                <p class="card-text" style="font-size: 0.875rem; color: white;">A brief description of the news article goes here. You can provide a summary of the article's content.</p>
                            </div>
                            <div class="card-footer text-center"> <!-- Center-align the button -->
                    ...
                    <div class="col-sm-9 col-md-6 col-lg-4 mb-4">
                        <div style="background: rgba(139, 0, 0, 0.85); backdrop-filter: blur(10px); border-radius: 10px; padding: 10px; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.boxShadow='0 12px 20px rgba(0, 0, 0, 0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none';">
                            <img src="img/demos/business-consulting-3/backgrounds/BCPM/DJI_0864.JPG" class="card-img-top" alt="Article Image">
                            <div class="card-body" >
                                <h4 class="font-weight-semibold text-color-light text-6 mb-1">News Title 3</h4>
                                <p class="card-text mb-3" style="font-size: 0.875rem; color: white;">Publication Date: January 1, 2023</p>
                                <p class="card-text" style="font-size: 0.875rem; color: white;">A brief description of the news article goes here. You can provide a summary of the article's content.</p>
                            </div>
                            <div class="card-footer text-center"> <!-- Center-align the button -->
