      ...
      <div class="container pt-3 mt-4">
        ...
        <div class="col-sm-9 col-md-6 col-lg-3 mb-4">
            <a href="stone-mining.php" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
                <div class="card box-shadow-4 max-width-card">
                ...
                <div class="card card-body d-flex flex-column align-items-start justify-content-between px-4 py-3" style="padding: 20px;">
                    <p class="card-text mb-3" style="font-size: 0.875rem; color: white;">
        ...
        <div class="col-sm-9 col-md-6 col-lg-3 mb-4">
            <a href="trading.php" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
                <div class="card box-shadow-4 max-width-card">
                    <div class="card-container">
                        <img src="img/demos/business-consulting-3/backgrounds/BCPM/DJI_0863.JPG" class="card-image" alt="Card Image">
                    </div>
                    <div class="image-overlay">
                ...
                <div class="card card-body d-flex flex-column align-items-start justify-content-between px-4 py-3" style="padding: 20px;">
                    <p class="card-text mb-3" style="font-size: 0.875rem; color: white;">
                        Expanding Horizons with PT Mineral Alam Abadi.
                    </p>
                </div>
                <div class="card card-body d-flex custom-view-more" style="justify-content: flex-end; align-items: end; padding: 0 20px;">
                    <img width="50" height="50" class="w-auto" src="img/demos/business-consulting-3/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" style="width: 50px; transition: transform 0.3s;">
        ...
        <!-- Card 5 - Mining Contractor -->
        <div class="col-sm-9 col-md-6 col-lg-3 mb-4">
            <a href="mining-contractor.php" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
                <div class="card box-shadow-4 max-width-card">
                    <div class="card-container">
                        <img src="img/demos/business-consulting-3/backgrounds/BCPM/DJI_0877.JPG" class="card-image" alt="Card Image">
                    </div>
                    <div class="image-overlay">
                ...
                <div class="card card-body d-flex flex-column align-items-start justify-content-between px-4 py-3" style="padding: 20px;">
                    <p class="card-text mb-3" style="font-size: 0.875rem; color: white;">
                        Forging Mining Partnerships with PT Mineral Alam Abadi.
                    </p>
                </div>
                <div class="card card-body d-flex custom-view-more" style="justify-content: flex-end; align-items: end; padding: 0 20px;">
                    <img width="50" height="50" class="w-auto" src="img/demos/business-consulting-3/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" style="width: 50px; transition: transform 0.3s;">
        ...
        <div class="col-sm-9 col-md-6 col-lg-3 mb-4">
            <a href="shipping.php" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
                <div class="card box-shadow-4 max-width-card">
                    <div class="card-container">
                        <img src="img/demos/business-consulting-3/assets-img-baru/shipping.png" class="card-image" alt="Card Image">
                    </div>
                    <div class="image-overlay">
                ...
                <div class="card card-body d-flex flex-column align-items-start justify-content-between px-4 py-3" style="padding: 20px;">
                    <p class="card-text mb-3" style="font-size: 0.875rem; color: white;">
                        Shipping Solutions from PT Mineral Alam Abadi.
                    </p>
                </div>
                <div class="card card-body d-flex custom-view-more" style="justify-content: flex-end; align-items: end; padding: 0 20px;">
                    <img width="50" height="50" class="w-auto" src="img/demos/business-consulting-3/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" style="width: 50px; transition: transform 0.3s;">
        ...
        <div class="col-sm-9 col-md-6 col-lg-3 mb-4">
            <a href="investment.php" class="custom-link-hover-effects text-decoration-none" data-cursor-effect-hover="plus">
                <div class="card box-shadow-4 max-width-card">
                    <div class="card-container">
                        <img src="img/demos/business-consulting-3/assets-img-baru/20230828_070937.jpg" class="card-image" alt="Card Image">
                    </div>
                    <div class="image-overlay">
                ...
                <div class="card card-body d-flex flex-column align-items-start justify-content-between px-4 py-3" style="padding: 20px;">
                    <p class="card-text mb-3" style="font-size: 0.875rem; color: white;">
                        Investing for Tomorrow's with PT Mineral Alam Abadi Vision.
                    </p>
                </div>
                <div class="card card-body d-flex custom-view-more" style="justify-content: flex-end; align-items: end; padding: 0 20px;">
                    <img width="50" height="50" class="w-auto" src="img/demos/business-consulting-3/icons/arrow-right.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light'}" style="width: 50px; transition: transform 0.3s;">
